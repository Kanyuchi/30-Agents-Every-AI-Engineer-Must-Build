...
Anchored to the Original Goal in `CLAUDE.md`: work through the book end-to-end
and adapt relevant agent patterns.

## Now (≤5)
1. Read the book PDF in `book/` alongside the code — start Ch 1 (Foundations).
2. Pick a default LLM provider and paste the key into the relevant chapter `.env` (all 17 `.env` files now exist as placeholders).
...
- Note any patterns worth pulling into other `~/Developer` projects.

## Later
- Adapt a chosen agent architecture into a real project.
