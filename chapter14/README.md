...
| [ch14_financial_legal_agents__RUN_CLAUDE_Sonnet4.ipynb](ch14_financial_legal_agents__RUN_CLAUDE_Sonnet4.ipynb) | Claude Sonnet 5 | Live LLM via `ANTHROPIC_API_KEY` |
...
Optional API services for Live Mode: OpenAI, Anthropic (Claude Sonnet 5), Google (Gemini Flash 2.5), or local Ollama (DeepSeek V2), Finnhub (free tier at finnhub.io), Tavily (free tier at tavily.com).
