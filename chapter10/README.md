...
| [ch10_conversational_and_content_creation_agents__RUN_CLAUDE_Sonnet4.ipynb](ch10_conversational_and_content_creation_agents__RUN_CLAUDE_Sonnet4.ipynb) | Claude Sonnet 5 | Live LLM via `ANTHROPIC_API_KEY` |
