...
| [ch13_healthcare_scientific_agents__RUN_CLAUDE_Sonnet4.ipynb](ch13_healthcare_scientific_agents__RUN_CLAUDE_Sonnet4.ipynb) | Claude Sonnet 5 | Live LLM via `ANTHROPIC_API_KEY` |
